...
class TestSelectCorrectAnswer(unittest.TestCase):
    def setUp(self):
        ...
        self.question = Question(question_id="Q1", text="Sample question?", is_open=False)
...
class TestPromptForResolution(unittest.TestCase):
    def setUp(self):
        ...
        self.question = Question(question_id="Q2", text="Another question?", is_open=False)
...
class TestResolveDiscrepancy(unittest.TestCase):
    def setUp(self):
        ...
        self.question = Question(question_id="Q3", text="Discrepant question?", is_open=False)
    ...
    def test_resolve_discrepancy_non_interactive_string(self):
        ...
        # We don't override it here since our dummy Question implementation can be used as is.
        # Provide correct_answer as string and a discrepancy reason.
        resolve_discrepancy(self.question, correct_answer="Opt2", discrepancy_reason="Matches policy", interactive=False)
    ...
    def test_resolve_discrepancy_non_interactive_index(self):
        ...
        resolve_discrepancy(self.question, correct_answer=2, discrepancy_reason="Index selected", interactive=False)
        self.assertIsNotNone(self.question.correct_answer)
    ...
    def test_resolve_discrepancy_interactive(self, mock_input):
        ...
        self.assertEqual(self.question.discrepancy_reason, "Reason provided interactively")
    ...
    def test_resolve_discrepancy_no_discrepancy(self):
        ...
        resolve_discrepancy(self.question, correct_answer=0, discrepancy_reason="None needed", interactive=False)
        self.assertIsNotNone(self.question.correct_answer)
        self.assertEqual(self.question.correct_answer.text, "Opt1")
        # In our implementation, when there are no discrepancies, encoder_id is not set, so it remains None.
    ...
    def test_resolve_discrepancy_missing_reason(self):
        ...
        with self.assertRaises(ValueError):
            resolve_discrepancy(self.question, correct_answer="Opt1", discrepancy_reason=None, interactive=False)
