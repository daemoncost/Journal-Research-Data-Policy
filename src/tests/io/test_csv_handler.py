...
class TestCSVProcessing(unittest.TestCase):
    def setUp(self):
        ...
        self.csv_content = """Zeitstempel,E-Mail-Adresse,Punkte,"Journal name or names, in case these replies apply to multiple journals (please separate the names by comma):",Publisher Name,OtherColumn
...
"""
    ...
    def test_normalize_columns(self):
        # Patch _normalize_journal and _normalize_publisher to return lower-case versions.
        ...
        try:
            ...
            if "Publisher Name" in df.columns:
                self.assertTrue(all(df["Publisher Name"].apply(lambda x: x == x.lower())))
        finally:
